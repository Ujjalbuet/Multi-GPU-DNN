...
DEFINE_int32(iterations, 468, "Number of iterations for training");
...
struct TrainingContext
{
    ...
    void test(float *dloss_data, float *fc2smax, int id){
	    cudaSetDevice(id);
	    dloss_data = fc2smax;
    }
...
//        checkCudaErrors(cudaMemcpy(dloss_data, fc2smax, sizeof(float) * m_batchSize * ref_fc2.outputs, cudaMemcpyDeviceToDevice));
//	    dloss_data = fc2smax;
